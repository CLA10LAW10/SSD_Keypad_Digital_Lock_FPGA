...
set_property -dict { PACKAGE_PIN Y7    IOSTANDARD LVCMOS33     } [get_ports { seg0[6] }]; #IO_L13P_T2_MRCC_13 Sch=jb_p[3]        
set_property -dict { PACKAGE_PIN Y6    IOSTANDARD LVCMOS33     } [get_ports { seg0[5] }]; #IO_L13N_T2_MRCC_13 Sch=jb_n[3]        
set_property -dict { PACKAGE_PIN V6    IOSTANDARD LVCMOS33     } [get_ports { seg0[4] }]; #IO_L22P_T3_13 Sch=jb_p[4]             
set_property -dict { PACKAGE_PIN W6    IOSTANDARD LVCMOS33     } [get_ports { seg0[3] }]; #IO_L22N_T3_13 Sch=jb_n[4] 
...
# # ##Pmod Header JD  
# set_property -dict { PACKAGE_PIN T14   IOSTANDARD LVCMOS33 } [get_ports { seg1[2] }]; #IO_L5P_T0_34 Sch=jd_p[1]  
# set_property -dict { PACKAGE_PIN T15   IOSTANDARD LVCMOS33 } [get_ports { seg1[1] }]; #IO_L5N_T0_34 Sch=jd_n[1]				 
# set_property -dict { PACKAGE_PIN P14   IOSTANDARD LVCMOS33 } [get_ports { seg1[0] }]; #IO_L6P_T0_34 Sch=jd_p[2]  
# set_property -dict { PACKAGE_PIN R14   IOSTANDARD LVCMOS33 } [get_ports { chip_sel1 }]; #IO_L6N_T0_VREF_34 Sch=jd_n[2]  

set_property -dict { PACKAGE_PIN U14   IOSTANDARD LVCMOS33 } [get_ports { seg1[6] }]; #IO_L11P_T1_SRCC_34 Sch=jd_p[3]    
set_property -dict { PACKAGE_PIN U15   IOSTANDARD LVCMOS33 } [get_ports { seg1[5] }]; #IO_L11N_T1_SRCC_34 Sch=jd_n[3]    
set_property -dict { PACKAGE_PIN V17   IOSTANDARD LVCMOS33 } [get_ports { seg1[4] }]; #IO_L21P_T3_DQS_34 Sch=jd_p[4] 
set_property -dict { PACKAGE_PIN V18   IOSTANDARD LVCMOS33 } [get_ports { seg1[3] }]; #IO_L21N_T3_DQS_34 Sch=jd_n[4] 
...
set_property -dict { PACKAGE_PIN V13   IOSTANDARD LVCMOS33 } [get_ports { seg1[2] }]; #IO_L3N_T0_DQS_34 Sch=je[7]                  
set_property -dict { PACKAGE_PIN U17   IOSTANDARD LVCMOS33 } [get_ports { seg1[1] }]; #IO_L9N_T1_DQS_34 Sch=je[8]                  
set_property -dict { PACKAGE_PIN T17   IOSTANDARD LVCMOS33 } [get_ports { seg1[0] }]; #IO_L20P_T3_34 Sch=je[9]                     
set_property -dict { PACKAGE_PIN Y17   IOSTANDARD LVCMOS33 } [get_ports { chip_sel1 }]; #IO_L7N_T1_34 Sch=je[10]                    