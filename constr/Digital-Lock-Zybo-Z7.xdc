...
set_property -dict { PACKAGE_PIN W14   IOSTANDARD LVCMOS33 } [get_ports { seg1[6] }]; #IO_L8P_T1_34 Sch=jc_p[3]  
set_property -dict { PACKAGE_PIN Y14   IOSTANDARD LVCMOS33 } [get_ports { seg1[5] }]; #IO_L8N_T1_34 Sch=jc_n[3]  
set_property -dict { PACKAGE_PIN T12   IOSTANDARD LVCMOS33 } [get_ports { seg1[4] }]; #IO_L2P_T0_34 Sch=jc_p[4]  
set_property -dict { PACKAGE_PIN U12   IOSTANDARD LVCMOS33 } [get_ports { seg1[3] }]; #IO_L2N_T0_34 Sch=jc_n[4]  
